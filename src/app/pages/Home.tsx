      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-[#D4A574] to-[#C49564] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto mb-8">
            Talk to our team and get a personalized export plan today.
          </p>
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-3 bg-slate-900 text-white rounded-full font-semibold shadow-lg shadow-slate-900/10 hover:bg-slate-800 transition"
          >
            Contact Us
          </a>
        </div>
